...
exports.deleteMeiliSearchIndex = exports.deleteDocumentFromIndex = exports.meiliClient = void 0;
exports.addDocumentToIndex = addDocumentToIndex;
const meilisearch_1 = require("meilisearch");
const config_1 = __importDefault(require("../config"));
const item_constant_1 = require("../modules/Item/item.constant");
...
function addDocumentToIndex(result, indexKey) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const firstImage = (images === null || images === void 0 ? void 0 : images[0]) || item_constant_1.noImage;
        const document = {
...
const deleteMeiliSearchIndex = (indexKey) => __awaiter(void 0, void 0, void 0, function* () {
    exports.meiliClient.deleteIndex(indexKey);
});
exports.deleteMeiliSearchIndex = deleteMeiliSearchIndex;
exports.default = exports.meiliClient;
